...
numPlnaetslider = Scale(root, from_=0, to=500, orient=HORIZONTAL, length=100)
...
class Planet():
    def __init__(self, name, x, y, mass, direction, velocity):
        ...
        self.circle = pyglet.shapes.Circle(self.x, self.y, self.radius, color=self.colour) # create the planet
